...
<head>
    <title>Atma Kitchen - Add Bahan Baku</title>
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <form class="user" action="{{ route('bahan_baku.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_bahan') }}" name="nama_bahan">
                                        @error('nama_bahan')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="font-weight-bold">Stok Bahan</label>
                                            <input type="number"
                                                class="form-control form-control-user @error('stok_bahan') is-invalid @enderror"
                                                id="inputStokBahan" placeholder="Stok Bahan" value="{{old('stok_bahan')}}"
                                                name="stok_bahan">
                                            @error('stok_bahan')
                                                <div class="invalid-feedback">
                                                    {{$message}}
